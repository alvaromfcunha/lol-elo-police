...
ALTER TABLE matches ADD COLUMN NEW_game_creation_at DATETIME NOT NULL DEFAULT 0;
...
ALTER TABLE matches ADD COLUMN NEW_game_ended_at DATETIME NOT NULL DEFAULT 0;
...
ALTER TABLE ranked_info ADD COLUMN created_at DATETIME NOT NULL DEFAULT 0;
...
-- +goose Down
-- +goose StatementBegin
ALTER TABLE matches ADD COLUMN NEW_game_creation_at TIMESTAMP NOT NULL DEFAULT 0;
UPDATE matches SET NEW_game_creation_at = game_creation_at;
ALTER TABLE matches DROP COLUMN game_creation_at;
ALTER TABLE matches RENAME COLUMN NEW_game_creation_at TO game_creation_at;

ALTER TABLE matches ADD COLUMN NEW_game_ended_at TIMESTAMP NOT NULL DEFAULT 0;
UPDATE matches SET NEW_game_ended_at = game_ended_at;
ALTER TABLE matches DROP COLUMN game_ended_at;
ALTER TABLE matches RENAME COLUMN NEW_game_ended_at TO game_ended_at;
